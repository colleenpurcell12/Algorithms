...
Prototypes
	// the object prototype is passes methods to the inheritors: functions, arrays, strings and numbers
...
Inheritance 
// ---is a concept where one class shares the structure and behavior defined in another class. Ifinheritance applied on one class is called Single Inheritance, and if it depends on multiple classes, then it is called multiple Inheritance.
...
Constructor
 // method used to initialize the state of an object, and it gets invoked at the time of object creation. Rules for constructor are:.
